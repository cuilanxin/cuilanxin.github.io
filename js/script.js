...
$$(function (){
  ...
  var clxabiaoqian = document.getElementById('clxabiaoqian')
  var fillpath = document.getElementById('switch-mode-clx1')
  console.log('fillpath: ', fillpath, fillpath.fillStyle);
  ...
  switchModeClx.addEventListener('click',()=>{
    if(localStorage.getItem("mdui-theme-layout-dark")) {
      ...
      clxabiaoqian && (clxabiaoqian.style.color = '#000')
      ...
      clxabiaoqian && (clxabiaoqian.style.color = '#bbb')
